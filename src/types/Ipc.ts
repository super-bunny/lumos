export enum IpcEvents {
  ...
  SET_WINDOWS_VISIBILITY = 'SET_WINDOWS_VISIBILITY',
  SET_OVERLAY_WINDOWS_VISIBILITY = 'SET_OVERLAY_WINDOWS_VISIBILITY',
  ...
  SET_OVERLAY_INFO = 'SET_OVERLAY_INFO',
  // Updater
  UPDATE_DOWNLOADED = 'UPDATE_DOWNLOADED',
  QUID_AND_INSTALL_UPDATE = 'QUID_AND_INSTALL_UPDATE',
}
